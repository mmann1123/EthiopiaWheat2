...
# road density 
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Transportation\RoadDen_5km_WLRC.tif", prefix="RdD5k", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Transportation\Transport Cost Surface\EucDist_Addis.tif", prefix="DAds", thematic=FALSE, proportion=FALSE,metrics=c("MN","MIN","MAX") );
...
for(layer in 1:dim(auc)[3]){writeRaster(auc[[layer]],paste(names(auc)[layer],'v4.tif',sep='_'),overwrite=T )} #v2 = auc < 0 is set to NA, v3: auc<0 and dry agri cor < .75 = NA , v3: auc<0 and dry agri cor < .85 = NA, v4 same as v3 but wet agri cor 

# EVI statistics Total AUC
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_TOTauc1_v4.tif", prefix="EVIT3", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_TOTauc2_v4.tif", prefix="EVIT4", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_TOTauc3_v4.tif", prefix="EVIT5", thematic=FALSE, proportion=FALSE,metrics=c("MN") );

# EVI statistics Increasing AUC
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_INCauc1_v4.tif", prefix="EVII3", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_INCauc2_v4.tif", prefix="EVII4", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_INCauc3_v4.tif", prefix="EVII5", thematic=FALSE, proportion=FALSE,metrics=c("MN") );

# EVI statistics Decreasing AUC
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_DECauc1_v4.tif", prefix="EVID3", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_DECauc2_v4.tif", prefix="EVID4", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_DECauc3_v4.tif", prefix="EVID5", thematic=FALSE, proportion=FALSE,metrics=c("MN") );

# EVI statistics MAX EVI
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_max1_b.tif", prefix="EVIMX3", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_max2_b.tif", prefix="EVIMX4", thematic=FALSE, proportion=FALSE,metrics=c("MN") );
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_max3_b.tif", prefix="EVIMX5", thematic=FALSE, proportion=FALSE,metrics=c("MN") );

# EVI statistics Other
isectpolyrst(in="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Administrative Areas\Kebele_WLRC_UTM.shp", raster="G:\Faculty\Mann\Projects\Ethiopia Project\GIS Data\Modis Vege\EVI_Outputs\result_peaks_b.tif", prefix="EVIMPK", thematic=FALSE, proportion=FALSE,metrics=c("MN") );  # # of peaks over time series
...
#The purpose of the 3B42 algorithm is to produce TRMM-adjusted merged-infrared (IR) precipitation and root-mean-square (RMS) precipitation-error estimates.  The algorithm consists of two separate steps.  The first step uses the TRMM VIRS and TMI orbit data (TRMM products 1B01 and 2A12) and the monthly TMI/TRMM Combined Instrument (TCI) calibration parameters (from TRMM product 3B31) to produce monthly IR calibration parameters.  
#The second step uses these derived monthly IR calibration parameters to adjust the 
#merged-IR precipitation data, which consists of GMS, GOES-E, GOES-W, Meteosat-7, Meteosat-5, and NOAA-12 data.  The final gridded, 
#adjusted merged-IR precipitation (mm/hr) and RMS precipitation-error estimates have a 3-hourly temporal resolution and a 0.25-degree by 0.25-degree spatial resolution.  Spatial coverage extends from 50 degrees south to 50 degrees north latitude.
...
############################################
# Spatial subset, only kebeles with wheat 
    library(sp)
    library(rgdal)
    library(foreign)
    setwd('G://Faculty//Mann//Projects//Ethiopia Project//GIS Data//Administrative Areas//')
    #ogrInfo(".", "Kebele_WLRC_UTM")
    kebele = readOGR(".", "Kebele_WLRC_UTM")
    
    # Recode Variables --------------------------------------------------------
    # find create factor of agro ecological zone type with highest proportion coverage
    kebele@data$AgEcoFactor = as.factor(names(kebele@data[,grep(colnames(kebele@data),pattern='AgEcoV')])[apply(kebele@data[,grep(colnames(kebele@data),pattern='AgEcoV')], 1, which.max)])
    # change names to match Eco zone name
    lookup = read.dbf('G://Faculty//Mann//Projects//Ethiopia Project//GIS Data//WLRC_Data_Original//Agroecology_UTM.dbf',as.is=T)
    lookup = unique(lookup[,c('GRIDCODE','Terminolog')])
    levels = data.frame(levels=as.numeric(sapply(levels(kebele$AgEcoFactor),function(x) substr(x,7,nchar(x)))))
    lookup2 = lookup[match(levels$levels,lookup$GRIDCODE),]
    levels(kebele@data$AgEcoFactor)=lookup2[,'Terminolog']
    
    # find create factor of soil type with highest proportion coverage
    kebele@data$SoilFactor = as.factor(names(kebele@data[,grep(colnames(kebele@data),pattern='SoilV')])[apply(kebele@data[,grep(colnames(kebele@data),pattern='SoilV')], 1, which.max)])
    # change names to match soil name
    lookup = read.dbf('G://Faculty//Mann//Projects//Ethiopia Project//GIS Data//WLRC_Data_Original//Soil_UTM.dbf',as.is=T)
    lookup = unique(lookup[,c('SOIL_CODE2','SOILTYPE')])
    levels = data.frame(levels=as.numeric(sapply(levels(kebele$SoilFactor),function(x) substr(x,6,nchar(x)))))
    lookup2 = lookup[match(levels$levels,lookup$SOIL_CODE2),]
    levels(kebele@data$SoilFactor)=lookup2[,'SOILTYPE']
    
    # find create factor of rainfall mm type with highest proportion coverage
    kebele@data$LYFactor <- as.factor(names(kebele@data[,grep(colnames(kebele@data),pattern='LYV')])[apply(kebele@data[,grep(colnames(kebele@data),pattern='LYV')], 1, which.max)])
    # change names to match long year
    lookup = read.dbf('G://Faculty//Mann//Projects//Ethiopia Project//GIS Data//WLRC_Data_Original//Long_Year_ARF_UTM.dbf',as.is=T)
    lookup = unique(lookup[,c('Zone_Id','Zone')])
    levels = data.frame(levels=as.numeric(sapply(levels(kebele$LYFactor),function(x) substr(x,4,nchar(x)))))
    lookup2 = lookup[match(levels$levels,lookup$Zone_Id),]
    levels(kebele@data$LYFactor)=lookup2[,'Zone']
    
    # change missing values for data created by GME
    kebele@data[kebele@data==min(kebele@data$OC4MN)|kebele@data==-2147483648|kebele@data==-21474836]=NA
    
    # Omit non-wheat areas
    kdata = read.dta('G://Faculty//Mann//Projects//Ethiopia Project//Regression Data//CSA-AgSS//AgSS2010-2012_Field_Information_Final_stata12.dta')
    #kdata = kdata[kdata$RK_CODE %in% kebele$RK_CODE,]     # restrict datasets to matching kcodes
    #kebele2 = kebele[kebele$RK_CODE %in% kdata$RK_CODE,]
    kebele$sort = 1:dim(kebele)[1]
    
    library(plyr)
    # merge data
    joined.df = join(kebele@data, kdata, type = "left" )
    # check if sorted correctly
    sum(joined.df$sort == kebele$sort) == length(kebele$sort)
    # switch data for polygons
    kebele@data =joined.df
    # write out whole dataset 
    writeOGR(kebele, ".", "Kebele_CSA-AGSS_UTM", driver="ESRI Shapefile")
  
    # restrict data
    kebele2 = kebele[kebele$R_CODE==1 |kebele$R_CODE==3 |kebele$R_CODE==4 |kebele$R_CODE==7 ,]
    kebele2 = kebele2[!is.na(kebele2$wheatOPH3) | !is.na(kebele2$wheatOPH4) | !is.na(kebele2$wheatOPH5),]
    plot(kebele2)
    writeOGR(kebele2, ".", "Kebele_CSA-AGSS_UTM_wheat", driver="ESRI Shapefile",overwrite_layer = T)
